<%-- 
    Document   : r-nav-editPatient
    Created on : 2 May, 2024, 12:31:04 PM
    Author     : Dashrath
--%>
...
<html>
    ...
    <body>
        ...
        <div class="register">
            <a href="d-nav-viewPatient.jsp"><i class="fa fa-arrow-left" aria-hidden="true"></i></a> <h2 style="text-align: center;margin-bottom: 20px;">Update Patient</h2>
              <%
               String mssg=(String)request.getAttribute("message");
               if(mssg!=null)
               {
                   out.println("<h2>"+mssg+"</h2>");
               }              
            %>
